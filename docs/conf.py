...
"""Configuration of sphinx build system."""
...
version = libproc.__version__
# The full version, including alpha/beta/rc tags.
release = libproc.__version__
...
man_pages = [
    ('index', 'libproc', u'libproc documentation',
